...
def create_shortened_url_using_db_id(database_session:Session, original_url:str) -> str:
...
def create_shortened_url_using_hash(database_session:Session, original_url:str) -> str:
